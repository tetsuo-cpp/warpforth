...
\ CHECK-NEXT:  %[[L42:.*]] = forth.constant %[[B1]](42 : i64) : !forth.stack -> !forth.stack
\ CHECK-NEXT:  cf.br ^bb3(%[[L42]] : !forth.stack)
\ CHECK:     ^bb2(%[[B2:.*]]: !forth.stack):
\ CHECK-NEXT:  %[[L99:.*]] = forth.constant %[[B2]](99 : i64) : !forth.stack -> !forth.stack
...
\ CHECK-NEXT:  %[[S2:.*]] = forth.constant %[[B3]](0 : i64) : !forth.stack -> !forth.stack
...
\ CHECK-NEXT:  %[[L7:.*]] = forth.constant %[[B4]](7 : i64) : !forth.stack -> !forth.stack
