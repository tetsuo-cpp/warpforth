...
\ MID: gpu.func @main(%arg0: memref<256xi32> {forth.param_name = "DATA"})
\ MID-SAME: workgroup(%{{.*}}: memref<256xi32, #gpu.address_space<workgroup>>)
\ MID-SAME: kernel
\ MID: memref.extract_aligned_pointer_as_index %{{.*}} : memref<256xi32, #gpu.address_space<workgroup>>
\ MID: llvm.store
\ MID: gpu.return
